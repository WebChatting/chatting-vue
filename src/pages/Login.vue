...
.account-container .right-container .sign-list .input-list .list .input-text::-webkit-input-placeholder {
  color: #8C8889;
}
.account-container .right-container .sign-list .input-list .list .input-text::-moz-placeholder {
  color: #8C8889;
}
.account-container .right-container .sign-list .input-list .list .input-text:-ms-input-placeholder {
  color: #8C8889;
}
.account-container .right-container .sign-list .input-list .list .input-text::-ms-input-placeholder {
  color: #8C8889;
